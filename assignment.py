...
if (num1 <= num2 and num2 <= num3) or (num3 <= num2 and num2 <= num1):
  print("Middle:", num2)
elif (num2 <= num1 and num1 <= num3) or (num3 <= num1 and num1 <= num2):
  print("Middle:", num1)
else:
  print("Middle:", num3)
...
user_score = int(input("Enter a number between 0 to 100: "))
...
compare_three(5,5,5)
compare_three(5,5,10)
compare_three(5,10,15)
...
is_in_range(50, 1, 100)
is_in_range(50, 100, 1)
is_in_range(150, 1, 100)
is_in_range(1, 1, 100)
...
print(lowest_of_three(5,20,11))
print(lowest_of_three(100,25,60))
print(lowest_of_three(8,9,30))
...
highest = best_of_two(a,b)
highest = best_of_two(highest, c)
...
lowest = worst_of_two(a,b)
lowest = worst_of_two(lowest,c)
...
if (a == highest and b == highest) or (a == highest and c == highest) or (b == highest and c == highest):
...
user_num1 = int(input("Enter first whole number: "))
user_num2 = int(input("Enter second whole number: "))
user_num3 = int(input("Enter third whole number: "))
...
if user_num2 > highest:
   highest = user_num2

if user_num3 > highest:
   highest = user_num3


# Find middle
if (user_num1 <= user_num2 and user_num2 <= user_num3) or (user_num3 <= user_num2 and user_num2 <= user_num1):
   middle = user_num2
elif (user_num2 <= user_num1 and user_num1 <= user_num3) or (user_num3 <= user_num1 and user_num1 <= user_num2):
   middle = user_num1
else:
   middle = user_num3
...
first = int(input("Enter first whole number: "))
second = int(input("Enter second whole number: "))
third = int(input("Enter third whole number: "))
